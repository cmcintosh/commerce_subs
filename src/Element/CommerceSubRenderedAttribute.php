...
namespace Drupal\commerce_sub\Element;
 ...
 *   '#type' => 'commerce_sub_rendered_attribute',
 ...
 * @endcode
 *
 * @FormElement("commerce_sub_rendered_attribute")
 */
class CommerceSubRenderedAttribute extends Radios {
  ...
  public static function processRadios(&$element, FormStateInterface $form_state, &$complete_form) {
    if (count($element['#options']) > 0) {
      $storage = \Drupal::entityTypeManager()->getStorage('commerce_sub_attribute_value');
      $view_builder = \Drupal::entityTypeManager()->getViewBuilder('commerce_sub_attribute_value');
      ...
      foreach ($element['#options'] as $key => $choice) {
        ...
        if (isset($element['#default_value']) && $element['#default_value'] == $key) {
          $attributes['class'][] = 'sub--rendered-attribute__selected';
        }
    ...
    $element['#attached']['library'][] = 'commerce_sub/rendered-attributes';
    $element['#attributes']['class'][] = 'sub--rendered-attribute';
