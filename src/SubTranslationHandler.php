...
/**
 * Defines the translation handler for subs.
 *
 * Based on NodeTranslationHandler.
 */
class SubTranslationHandler extends ContentTranslationHandler {
  ...
  public function entityFormAlter(array &$form, FormStateInterface $form_state, EntityInterface $entity) {
    ...
    if (isset($form['content_translation'])) {
      $form['content_translation'] += [
        '#group' => 'advanced',
        '#attributes' => [
          'class' => ['sub-translation-options'],
        ],
      ];
      $form['content_translation']['#weight'] = 100;
      // The basic sub values will be used, no need for specific elements.
