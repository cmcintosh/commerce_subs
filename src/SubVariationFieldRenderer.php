...
class SubVariationFieldRenderer implements SubVariationFieldRendererInterface {
  ...
  /**
   * The sub variation view builder.
   *
  ...
  /**
   * Constructs a new SubVariationFieldRenderer object.
   *
  ...
  public function __construct(EntityTypeManagerInterface $entity_type_manager, EntityFieldManagerInterface $entity_field_manager) {
    ...
    $this->variationViewBuilder = $entity_type_manager->getViewBuilder('commerce_sub_variation');
  }
   ...
   * {@inheritdoc}
   */
  public function renderFields(SubVariationInterface $variation, $view_mode = 'default') {
    $rendered_fields = [];
   ...
   * {@inheritdoc}
   */
  public function renderField($field_name, SubVariationInterface $variation, $display_options = []) {
   ...
   * {@inheritdoc}
   */
  public function replaceRenderedFields(AjaxResponse $response, SubVariationInterface $variation, $view_mode = 'default') {
   ...
   *   The CSS class.
   */
  protected function buildAjaxReplacementClass($field_name, SubVariationInterface $variation) {
    return 'sub--variation-field--variation_' . $field_name . '__' . $variation->getSubId();
  }
