...
/**
 * Provides the form for adding sub attribute translations.
 */
class SubAttributeTranslationAddForm extends ConfigTranslationAddForm {
  ...
  /**
   * Constructs a new SubAttributeTranslationAddForm object.
   *
