...
/**
 * Provides the form for editing sub attribute translations.
 */
class SubAttributeTranslationEditForm extends ConfigTranslationEditForm {

  use SubAttributeTranslationFormTrait;
  ...
  /**
   * Constructs a new SubAttributeTranslationEditForm object.
   *
