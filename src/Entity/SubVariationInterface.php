...
/**
 * Defines the interface for sub variations.
 */
interface SubVariationInterface extends PurchasableEntityInterface, EntityChangedInterface, EntityOwnerInterface {

  /**
   * Gets the parent sub.
   *
   * @return SubInterface|null
   *   The sub entity, or null.
   */
  public function getSub();

  /**
   * Gets the parent sub ID.
   *
   * @return int|null
   *   The sub ID, or null.
   */
   ...
   *   The field name.
   *
   * @return \Drupal\commerce_sub\Entity\SubAttributeValueInterface|null
