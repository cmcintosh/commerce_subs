...
/**
 * Plugin implementation of the 'commerce_sub_variation_title' widget.
 *
 * @FieldWidget(
 *   id = "commerce_sub_variation_title",
 *   label = @Translation("Sub variation title"),
 *   field_types = {
 *     "entity_reference"
 *   }
 * )
 */
class SubVariationTitleWidget extends SubVariationWidgetBase implements ContainerFactoryPluginInterface {
  ...
  public function formElement(FieldItemListInterface $items, $delta, array $element, array &$form, FormStateInterface $form_state) {
    ...
    /** @var \Drupal\commerce_sub\Entity\SubVariationInterface[] $variations */
