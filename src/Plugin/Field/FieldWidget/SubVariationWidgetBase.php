...
use Drupal\commerce_sub\Event\SubVariationAjaxChangeEvent;
...
/**
 * Provides the base structure for sub variation widgets.
 *
 * Sub variation widget forms depends on the 'sub' being present in
 * $form_state.
 *
 * @see \Drupal\commerce_sub\Plugin\Field\FieldFormatter\AddToCartFormatter::viewElements().
 */
abstract class SubVariationWidgetBase extends WidgetBase implements ContainerFactoryPluginInterface {
  ...
  /**
   * Constructs a new SubVariationWidgetBase object.
   *
  ...
  public function __construct($plugin_id, $plugin_definition, FieldDefinitionInterface $field_definition, array $settings, array $third_party_settings, EntityTypeManagerInterface $entity_type_manager) {
    ...
    $this->variationStorage = $entity_type_manager->getStorage('commerce_sub_variation');
  }
  ...
  public static function ajaxRefresh(array $form, FormStateInterface $form_state) {
    ...
    $variation = SubVariation::load($form_state->get('selected_variation'));
    /** @var \Drupal\commerce_sub\SubVariationFieldRendererInterface $variation_field_renderer */
    $variation_field_renderer = \Drupal::service('commerce_sub.variation_field_renderer');
    ...
    $event = new SubVariationAjaxChangeEvent($variation, $response, $view_mode);
    $event_dispatcher = \Drupal::service('event_dispatcher');
    $event_dispatcher->dispatch(SubEvents::PRODUCT_VARIATION_AJAX_CHANGE, $event);
